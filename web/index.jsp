...
//				var j=abc[i];
//					str+="<li><span>[特惠]</span><a href='#'>"+j.title+"</a></li>"
//				}
//				alert(str);
//				$("#news").html(str);
//			}
...
//		$.get("easybuy_newsServlet","",function(abc){
//				var str="";
//				for(var i=0;i<abc.length;i++){
//				var j=abc[i];
//				str+="<li><span>[特惠]</span><a href='#'>"+j.title+"</a></li>"
...
//		})
		...
		$.getJSON("newsServlet","",function(abc){
				var str="";
				for(var i=0;i<abc.length;i++){
				var j=abc[i];
				str+="<li><span>[特惠]</span><a href='#'>"+j.title+"</a></li>"
...
<div class="top">
    <div class="logo"><a href="categoryServlet"><img src="images/logo.png" /></a></div>
    <div class="search">
    	<form>
...
<div class="menu_bg">
	<div class="menu">
    	...
    	<div class="nav">
            ...
            <div class="leftNav">
                <ul>      
                <c:forEach items="${lblist}" var="cate">
                    <li>
                    	<div class="fj">
                        ...
                        <div class="zj">
                            <div class="zj_l">
                                <div class="zj_l_c">
                                	<c:forEach items="${cate.childCategory}" var="cate2">
                                		<h2>${cate2.name }</h2>
                                    		<c:forEach items="${cate2.childCategory }" var="cate3">
                                    			<a href="#">${cate3.name }</a>|
                                		</c:forEach>
                                	</c:forEach>
                                </div>
